        ...
        <Row>
          <Col
            ...
            <FloatingLabel controlId="floatingTanggal" label="tanggal">
              {
                data != null ? 
                <Form.Control plaintext readOnly  type="text" value={data.tgl_transaksi.split('-').reverse().join('/')} />
                : <FiLoader/>
              }
            </FloatingLabel>
            ...
            <FloatingLabel controlId="floatingSupplier" label="Supplier">
              {
                data != null ? 
                <Form.Control plaintext readOnly className="fs-3" type="text" value={data.nama} />
                : <FiLoader/>
              }
            </FloatingLabel>
              ...
              <ListGroup className="my-3">
                {
                  ...
                  dataBarang.map((barang,index)=>{
                    return(
                      <ListGroup.Item key={index} style={{position:"relative", cursor:'pointer'}}>
                        <InfoRoll>
                          <span className="fs-3">{barang.roll}</span><br/>
                          <small>roll</small>
                        </InfoRoll>
                        <div className="mb-1">
                          <div style={listStyled} onClick={()=>editFunc(index)} className="fs-2">{barang.barang_nama}</div>
                ...
                <ListGroup.Item style={{position:"relative", cursor:'pointer'}}>
                      <InfoRoll >
                        <span className="fs-3">2</span><br/>
                        <small>roll</small>
                      </InfoRoll>
                      <div className="mb-1">
                        <div style={listStyled}  className="fs-2">RJN Black</div>
                        <small>232 yard</small> <small className="mute-text"> - dummy</small>
                      </div>
                  </ListGroup.Item>
                  ...
                  <ListGroup.Item style={{position:"relative", cursor:'pointer'}}>
                      ...
                      <div className="mb-1">
                        <div style={listStyled}  className="fs-2">Heavy Taslan Forest Green</div>
                        <small>199 yard</small> <small className="mute-text"> - dummy</small>
                      </div>
                  </ListGroup.Item>                  
